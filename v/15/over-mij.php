...
<head>
    ...
    <link rel="stylesheet" href="/v/15/assets/css/main.css" title="default" />
    <script defer src="/v/15/assets/js/menu.js"></script>
...
<body>
    ...
    <header class="pageheader">
        <p class="title"><a href="/v/15/">Robin Boers</a></p>

        <img src="/assets/images/ui/menu.svg" alt="menu button" class="menu-button" hidden />

        <nav>
            <ul class="menu">
                <li><a href="/v/15/">Home</a></li>
                <li class="selected">Over mij</li>
                <li><a href="/v/15/projecten">Projecten</a></li>
                <li><a href="/v/15/boeken">Boeken</a></li>
    ...
    <main id="content" class="page-content">
        <article>
            ...
            <section>
                ...
                <p>
                    Ik host mijn website bij <a href="https://www.bhosted.nl?ref=97f4c4a4b13e269e12cfd4f0352ba527">bHosted</a>. Ik ben daar ongeveer 30 euro per jaar aan kwijt. Ik heb inmiddels websites voor <a href="http://www.groendoenerij.nl">mijn vader</a>, <a href="https://jokessterrenkruid.blogspot.com">mijn oma</a>, <a href="https://thesisevelineboers.blogspot.com/">mijn moeder</a>
                    en <a href="https://hvm-oldscool.nl">mijn opa</a>
                    ontworpen (nu alleen mijn zusje nog 🙈)
                </p>
            </section>
            ...
            <section>
                ...
                <form action="https://api.geheimesite.nl/contact/form" method="post">
                    ...
                    <input class="input button" type="submit" name="send" value="Verzenden" />
                </form>
            </section>
