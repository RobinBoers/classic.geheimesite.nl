  ...
  if (!("Notification" in window)) {
    ...
    if(type = true){
       notification.onclick = function(){
           window.open('https://www.geheimesite.nlhttps://geheimesite.nl/website/nindo/messages/message.php?id='+id, '_blank');
       };
    } else {
       notification.onclick = function(){
           window.open('https://www.geheimesite.nlhttps://geheimesite.nl/website/nindo/messenger.php?id='+id, '_blank');
       }; 
    }
  }
