...
<body>
    ...
    <header class="pageheader">
        ...
        <nav>
            <ul class="menu">
                <li><a href="/v/16/en/">Home</a></li>
                <li><a href="/v/16/en/about">About me</a></li>
                <li><a href="/v/16/en/projects">Projects</a></li>
                <li><a href="/v/16/en/books">Books</a></li>
    ...
    <main id="content" class="page-content">
        <article>
            ...
            <section>
                ...
                <p>I built my own barebones statistics tracker. It tracks visits, not views, per post. The results are <a href="/v/16/blog/stats">publicly available</a> can be filtered per month and are shown in a simple graph that I built using Chart.js.</p>
            </section>
            ...
            <section>
                ...
                <p>The projects page pulls my repositories from my GitHub account using the GitHub API. The thumbnails shown are <code>screenshot.png</code> files at the root of each project's repository. If there is no such file I display a default empty one using <a href="https://placeholder.com">placeholder.com</a>. The source code for the script can be found here: <a href="/v/16/assets/js/github.js"><code>github.js</code></a></p>

                <p>The books page works similarly. It pulls the books from <a href="https://micro.blog">Micro.blog</a> bookshelves. The source code for that script can be found here: <a href="/v/16/assets/js/bookshelves.js"><code>bookshelves.js</code></a>. The problem is that the microblog API requires an access token to get access to the bookshelves, but doesn't allow scopes. That means the token can get access to my entire account, including the ability to comment and post. That's why I built <a href="https://github.com/RobinBoers/geheimesite.nl/blob/master/src/api/books/README.md">my own wrapper around the Micro.blog API</a>, that hides the token for me.</p>
            </section>
