...
<html lang="en">
    <head>
        ...
        <style>
            ...
            html {
                background: 
                    linear-gradient(to right, magenta, orangered);
        ...
        <main id="content" class="page-content text-foreground bg-background pt-[50px] pb-[27px] border-x-0 border-solid border-t-[7px] border-primary">
            ...
            <article>
                <section>
                    ...
                    <p>
                        <strong class="video-title">Why The Web Is Such A Mess</strong>
                    ...
                    <p>
                        ...
                        <a href="https://www.youtube.com/watch?v=6avJHaC3C2U">https://www.youtube.com/watch?v=6avJHaC3C2U</a>
                    </p>
                    <p>
                        <strong class="video-title">Plain Text</strong>
                        <em class="video-author">Dylan Beattie</em>
                        <a href="https://www.youtube.com/watch?v=_mZBa3sqTrI">https://www.youtube.com/watch?v=_mZBa3sqTrI</a>
                    </p>
                    <p>
                        <strong class="video-title">The Web That Never Was</strong>
                        <em class="video-author">Dylan Beattie</em>
                        <a href="https://www.youtube.com/watch?v=8JOD1AQGqEg">https://www.youtube.com/watch?v=8JOD1AQGqEg</a>
                    </p>
                    <p>
                        <strong class="video-title">Computational Creativity</strong>
                        <em class="video-author">Dylan Beattie</em>
                    ...
                    <p>
                        ...
                        <a href="https://www.youtube.com/watch?v=MijmeoH9LT4">https://www.youtube.com/watch?v=MijmeoH9LT4</a>
                    </p>
                    <p>
                        <strong class="video-title">Floating Point Numbers</strong>
                        <em class="video-author">Computerphile</em>
                    ...
                    <p>
                        <strong class="video-title">The Problem with Time &amp; Timezones</strong>
                        <em class="video-author">Computerphile</em>
                ...
                <section>
                    ...
                    <p><strong class="video-title">Why Gravity is NOT a Force</strong>
                        <em class="video-author">Veritasium</em>
                        <a href="https://www.youtube.com/watch?v=XRr1kaXKBsU">https://www.youtube.com/watch?v=XRr1kaXKBsU</a>
                    </p>
                    <p><strong class="video-title">The Science of Thinking</strong>
                        <em class="video-author">Veritasium</em>
                        <a href="https://www.youtube.com/watch?v=UBVV8pch1dM">https://www.youtube.com/watch?v=UBVV8pch1dM</a>
                    </p>
                    <p><strong class="video-title">This equation will change how you see the world (the logistic map)</strong>
                        <em class="video-author">Veritasium</em>
                        <a href="https://www.youtube.com/watch?v=ovJcsL7vyrk">https://www.youtube.com/watch?v=ovJcsL7vyrk</a>
                    </p>
                    <p><strong class="video-title">Chaos: The Science of the Butterfly Effect</strong>
                        <em class="video-author">Veritasium</em>
                        <a href="https://www.youtube.com/watch?v=fDek6cYijxI">https://www.youtube.com/watch?v=fDek6cYijxI</a>
                    </p>
                    <p><strong class="video-title">The Simplest Math Problem No One Can Solve - Collatz Conjecture</strong>
                        <em class="video-author">Veritasium</em>
                        <a href="https://www.youtube.com/watch?v=094y1Z2wpJg">https://www.youtube.com/watch?v=094y1Z2wpJg</a>
                    </p>
                    <p><strong class="video-title">The Golden Ratio (why it is so irrational)</strong>
                        <em class="video-author">Numberphile</em>
                        <a href="https://www.youtube.com/watch?v=sj8Sg8qnjOg">https://www.youtube.com/watch?v=sj8Sg8qnjOg</a>
                    </p>
                    <p><strong class="video-title">How An Infinite Hotel Ran Out Of Room</strong>
                        <em class="video-author">Veritasium</em>
                        <a href="https://www.youtube.com/watch?v=OxGsU8oIWjY">https://www.youtube.com/watch?v=OxGsU8oIWjY</a>
                    </p>
                    <p><strong class="video-title">Math&#39;s Fundamental Flaw</strong>
                        <em class="video-author">Veritasium</em>
                        <a href="https://www.youtube.com/watch?v=HeQX2HjkcNo&amp;t=217s">https://www.youtube.com/watch?v=HeQX2HjkcNo&amp;t=217s</a>
                    </p>
                    <p><strong class="video-title">The Universe is Hostile to Computers</strong>
                        <em class="video-author">Veritasium</em>
                        <a href="https://www.youtube.com/watch?v=AaZ_RSt0KP8">https://www.youtube.com/watch?v=AaZ_RSt0KP8</a>
                    </p>
                    <p><strong class="video-title">How Imaginary Numbers Were Invented</strong>
                        <em class="video-author">Veritasium</em>
                ...
                <section>
                    ...
                    <p><strong class="video-title">The Struggle of Building the Original iPhone - The Untold Story</strong>
                        <em class="video-author">ColdFusion</em>
                        <a href="https://www.youtube.com/watch?v=24O00Jz8R04">https://www.youtube.com/watch?v=24O00Jz8R04</a>
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p><strong class="video-title">Junk Mail, Explained</strong>
                        <em class="video-author">Johnny Harris</em>
                        <a href="https://www.youtube.com/watch?v=yyWjHVmZWvg">https://www.youtube.com/watch?v=yyWjHVmZWvg</a>
                    </p>
                    <p><strong class="video-title">Why Americans Eat Dessert for Breakfast</strong>
                        <em class="video-author">Johnny Harris</em>
                ...
                <section>
                    <h2 id="other-nice-stuff">Other nice stuff</h2>

                    <p><strong class="video-title">Ə: The Most Common Vowel in English</strong>
                        <em class="video-author">Tom Scott</em>
                    ...
                    <p><strong class="video-title">Most People Don&#39;t Know How Bikes Work</strong>
                        <em class="video-author">Veritasium</em>
                        <a href="https://www.youtube.com/watch?v=9cNmUNHSBac">https://www.youtube.com/watch?v=9cNmUNHSBac</a>
                    </p>
                </section>
