...
<html lang="nl">
    <head>
        ...
        <title>Project: CutieTanks — geheimesite.nl | Robin Boers</title>
    ...
    <body>
        ...
        <main id="content" class="page-content">
            <article>
                <section>
                    <h1>Project: CutieTanks</h1>
                    <p>
                        Dit is een arcade game die je met max 4 spelers kan spelen waarbij de laatst overlevende wint. <br />
                    ...
                    <p>
                        <a href="http://robijntje.itch.io/cutie-tanks">Speel op itch.io</a>
                    </p>
                ...
                <img class="w-full" src="https://raw.githubusercontent.com/RobinBoers/cutie-tanks/main/artwork/banner.png" alt="Screenshot" />
            </article>
        </main>
