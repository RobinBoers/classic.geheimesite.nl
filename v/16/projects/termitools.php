...
<html lang="nl">
    <head>
        ...
        <title>Project: TermiTools — geheimesite.nl | Robin Boers</title>
        ...
        <main id="content" class="page-content">
            <article>
                <section>
                    ...
                    <p>
                        <a href="https://github.com/RobinBoers/termitools">Meer information op github</a>
                    </p>
                </section>
                <img class="w-full" src="/v/16/assets/images/projects/termitools.png" alt="Screenshot" />
            </article>
        </main>
