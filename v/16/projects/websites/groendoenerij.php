...
<html lang="nl">
    <head>
        ...
        <title>Website: Groendoenerij — geheimesite.nl | Robin Boers</title>
        ...
        <main id="content" class="page-content">
            <article>
                <section>
                    ...
                    <p>
                        <a href="http://www.groendoenerij.nl">http://www.groendoenerij.nl</a>
                    </p>
                </section>
                <img class="w-full" src="/v/16/assets/images/projects/groendoenerij.png" alt="Screenshot" />
            </article>
        </main>
