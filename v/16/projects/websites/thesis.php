...
<html lang="nl">
    <head>
        ...
        <title>Website: Thesis Eveline Boers — geheimesite.nl | Robin Boers</title>
    ...
    <body>
        ...
        <main id="content" class="page-content">
            <article>
                <section>
                    <h1>Website: Thesis Eveline Boers</h1>
                    <p>
                    ...
                    <p>
                        Je vind de website hier: <a href="https://thesisevelineboers.blogspot.com/">https://thesisevelineboers.blogspot.com</a>
                    </p>
                </section>
                <img class="w-full" src="/v/16/assets/images/projects/thesis.png" alt="Screenshot" />
            </article>
        </main>
