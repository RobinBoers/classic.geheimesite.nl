...
<html lang="nl">
    <head>
        ...
        <title>Website: Old's Cool (HVM Educatie) — geheimesite.nl | Robin Boers</title>
    ...
    <body>
        ...
        <main id="content" class="page-content">
            <article>
                <section>
                    <h1>Website: Old's Cool (HVM Educatie)</h1>
                    <p>
                    ...
                    <p>
                        <a href="https://hvm-oldscool.nl">Klik hier om de website te bezoeken :)</a>
                    </p>
                </section>
                <img class="w-full" src="/v/16/assets/images/projects/nutsbedrijven.png" alt="Screenshot" />
            </article>
        </main>
