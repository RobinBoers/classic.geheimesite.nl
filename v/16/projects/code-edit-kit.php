            ...
            <article>
                <section>
                    ...
                    <p class="text-warning">
                        Dit is een oud project wat erg buggy is, en niet meer wordt geüpdate! Ik heb wel een nieuwer project wat hier op lijkt, maar met experimenteel webUSB en webStorage support. Je kan het hier vinden: <a href="vskodium">VSKodium</a>
                    </p>
                </section>
                <img class="w-full" src="/v/16/assets/images/projects/code-editor.png" alt="Screenshot" />
            </article>
        </main>
