    ...
    <main id="content" class="page-content">
        <article>
            <div class="flex flex-col lg:flex-row items-center">
                ...
                <img class="w-full h-60 mb-5 lg:rotate-1 rounded-xl aspect-square object-cover object-right-top lg:mb-0 lg:h-fit lg:w-1/5" src="/v/16/assets/images/me.jpeg" alt="Dit ben ik">
            </div>
            ...
            <section>
                ...
                <p class="mt-2">
                    <a href="/v/16/how-it-was-made">Lees meer over deze site...</a>
                </p>
            </section>
