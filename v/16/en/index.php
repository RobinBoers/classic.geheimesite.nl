    ...
    <main id="content" class="page-content mt-0 md:mt-6">
        <article class="homepage-hero">
            <article class="homepage-section h-card max-w-none lg:max-w-xl">
                ...
                <p>Wanna know more about me? Check the <a href="/v/16/en/about">about me</a> page. If you want to see my work you can take a look at the <a href="/v/16/en/projects">projects</a> page. If you're mostly interested in the code, check my <a href="https://github.com/RobinBoers">GitHub profile</a>.</p>
