    ...
    <main id="content" class="page-content">
        <article>
            <div class="flex flex-col lg:flex-row items-center">
                ...
                <img class="w-full h-60 mb-5 lg:rotate-1 rounded-xl aspect-square object-cover object-right-top lg:mb-0 lg:h-fit lg:w-1/5" src="/v/16/assets/images/me.jpeg" alt="This is me">
            </div>
            ...
            <div class="flex flex-col lg:flex-row justify-center items-center gap-1 lg:gap-4">
                <img class="w-full lg:w-auto" src="https://github-readme-stats.vercel.app/api/top-langs/?username=RobinBoers&layout=compact&title_color=434d58" alt="Most used programming languages in my projects">
            ...
            <section>
                ...
                <p class="mt-2">
                    <a href="/v/16/how-it-was-made">Read more about this site...</a>
                </p>
            </section>
            ...
            <section>
                ...
                <p>
                    Wanna send me a message?<br />This is one of my six email addresses: <a href="mailto:hello@geheimesite.nl">hello@geheimesite.nl</a><br />
