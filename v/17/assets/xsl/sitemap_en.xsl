		...
		<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
			<head>
				...
				<link rel="stylesheet" href="https://geheimesite.nl/assets/css/main.css"
					type="text/css" />
				<script defer="defer" src="/v/17/assets/js/menu.js"></script>
			...
			<body>
				...
				<header class="page-header">
					...
					<nav>
						<ul class="menu">
							<li>
								<a href="/v/17/en">Home</a>
							</li>
							<li>
								<a href="/v/17/en/about">About me</a>
							</li>
							<li>
								<a href="/v/17/en/projects">Projects</a>
							</li>
							<li>
								<a href="/v/17/en/books">Books</a>
							</li>
							<li>
								<a href="https://blog.geheimesite.nl/en">Blog</a>
							</li>
							<li>
								<a href="/v/17/en/more">More</a>
							</li>
						</ul>
					</nav>
				</header>
