            ...
            <?php if($_SESSION['login19'] == true) { ?>
                <div class="w3-card w3-round w3-white w3-center">
                    <div class="w3-container w3-padding">
                        <a href="/v/18/account/index.php">Mijn account</a><br>
                        <a href="/v/18/account/uitloggen.php">Uitloggen</a><br>
                    </div>
                </div>
            <?php } else { ?>
                <div class="w3-card w3-round w3-white w3-center">
                    <div class="w3-container w3-padding">
                        <a href="/v/18/account/inloggen.php">Inloggen</a><br>
                        <a href="/v/18/account/aanmelden.php">Aanmelden</a><br>
                    </div>
                </div>
            <?php } ?>
            <br>
