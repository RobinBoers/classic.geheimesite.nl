...
<div id="SmallNav" class="small-nav">
    ...
    <a href="/v/14/index.php" class="w3-button">Home</a>
    <a href="/v/14/over-mij.php" class="w3-button">Over mij</a>
    <a href="https://github.com/RobinBoers" class="w3-button">GitHub</a>
    <a href="/v/14/projecten.php" class="w3-button">Projecten</a>
...
<header>
  <div class="w3-bar w3-padding">
      ...
      <div class="w3-right w3-hide-small">
          <a href="/v/14/index.php" class="w3-bar-item w3-button">Home</a>
          <a href="/v/14/over-mij.php" class="w3-bar-item w3-button">Over mij</a>
          <a href="https://github.com/RobinBoers" class="w3-bar-item w3-button">GitHub</a>
          <a href="/v/14/projecten.php" class="w3-bar-item w3-button">Projecten</a>
